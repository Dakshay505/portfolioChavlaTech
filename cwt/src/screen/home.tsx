  ...
  return (
    <div className="w-full">
      <div className="bg-primary-dark pb-[12rem] ">
        ...
        <div className="mt-[8rem] flex flex-col items-center space-y-10">
          <div className="flex md:flex-row flex-col items-center relative md:gap-10 justify-center w-[70%] h-[8rem] rounded-3xl bg-opacity-10 bg-primary-light">
            ...
            <div>
              <img src={triangle} alt="" className="md:w-[10%] absolute w-[20%] inset-0 md:left-[-3.5rem] md:top-3 top-[-3rem] left-[40%] right-[40%]" />
            </div>
          </div>
          <div className="flex md:flex-row flex-col items-center relative md:gap-10 justify-center w-[70%] h-[8rem] rounded-3xl bg-opacity-10 bg-primary-light">
            ...
            <p className="text-primary-light text-center mt-1 text-sm md:text-md font-semibold">Elevate User Experiences with our Unparalleled UI/UX Expertise</p>
            <div>
              <img src={square} alt="" className="md:w-[10%] absolute w-[20%] inset-0 md:left-[-3.5rem] md:top-3 top-[-3rem] left-[40%] right-[40%]" />
            </div>
          </div>
          <div className="flex md:flex-row flex-col items-center relative md:gap-10 justify-center w-[70%] h-[8rem] rounded-3xl bg-opacity-10 bg-primary-light">
            ...
            <p className="text-primary-light text-center mt-1 text-sm md:text-md font-semibold">Elevate User Experiences with our Unparalleled UI/UX Expertise</p>
            <div>
              <img src={circle} alt="" className="md:w-[10%] absolute w-[20%] inset-0 md:left-[-3.5rem] md:top-3 top-[-3rem] left-[40%] right-[40%]" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-primary-dark pb-[5rem] py-10">
        <div className="flex flex-col space-y-3 items-center text-center mt-10">
          <h1 className="text-primary-green w-[55%] text-4xl font-bold">Tech leaders from leading companies have trusted Brainhub to build impactful software.</h1>
        ...
        <div className="flex mt-[5rem] md:flex-row md:px-0 px-5 flex-col gap-10 md:gap-[10rem] items-center justify-center">
          <div className="flex flex-col space-y-5 w-[15rem]">
            ...
            <div>
              <p className="text-primary-green font-semibold text-xl">Lora Smith</p>
