    ...
    <>
      ...
      <div className="flex flex-col md:flex-col md:mx-[7%]">
        ...
        <div className="text-center mt-3 md:order-none order-last">
          <p className="text-sm text-center">© 2023 Chawla Technologies Pvt. Ltd.</p>
        </div>
        <hr />
        <footer>
          {/* logo */}
          <div className="justify-center gap-5 container mx-auto flex flex-col md:flex-row items-center lg:justify-between py-4">
            ...
            {/* HOME ABOUT */}
            <nav className="flex items-center md:flex-row flex-col gap-[1em] md:mb-0 md:order-2 order-first">
              ...
              <Link to="/Services" className="hover:text-gray-300 text-sm">
                Services
              </Link>
              <Link to="/CaseStudies" className="hover:text-gray-300 text-sm whitespace-nowrap">
                Case Studies
              </Link>
            ...
            <div className="flex items-center space-x-2 order-3">
              <a href="https://www.linkedin.com/in/chawla-technology-00836827a/">
                <img
              ...
              <a href="https://www.facebook.com/people/Chawla-Technologies/100094141071043/">
                <img
                  className="w-[45px] h-[45px] text-white hover:text-gray-300"
                  src={fb}
                  alt=""
              ...
              <a href="https://www.instagram.com/chawlatech/">
                <img
                  className="w-[45px] h-[45px] text-white hover:text-gray-300"
                  src={insta}
                  alt=""
              ...
              <a href="https://www.youtube.com/@chawlatech/featured">
                <img
                  className="w-[45px] h-[45px] text-white hover:text-gray-300"
                  src={yt}
                  alt=""
